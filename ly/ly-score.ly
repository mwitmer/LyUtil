...
%%
%% The functionality of ly-score:make-score has been split between ly-score:make-layout-score and ly-score:make-audio-score.
%% Procedure ly-score:make-layout-score returns the graphical score (with music transposed if necessary).
%% The music returned by ly-score:make-audio-score *never* transposed.
%%
%% These two procedures are called in sequence from the places where ly-score:make-score
%% was previously called (ly-score:process, and create-part)
%%
...
#(define (ly-score:make-layout-score folder header instruments is-full-score? is-transposed? layout include-midi?)
   ;;
   ;; Add music for a graphical score, observe transposition if is-transposed? is set.
   ;; This is called as a separate pass from any audio (midi) processing, in order to allow
